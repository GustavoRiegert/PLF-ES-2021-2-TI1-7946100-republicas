...
Objetos e lugares: Celular: Usa com mais frequência para se comunicar e manter-se informado. Notebook: Usa para entretenimento e para trabalhar.   <br/>         
...
|João Victor      |Uma forma de conversar com as pessoas que dividirá a república antes de decidir, para poder ter uma avaliação se será de agrado para todos     |Uma amostra do perfil das pessoas que irá morar junto para achar pontos de interesses comum  |
...
|Giovana Melo | As coisas que tem próximo a casa, Informações sobre o bairro (supermercados, farmácias, atendimento médico) | Diminuição dos gastos com transportes para esses locais   |
...
|RF-006 | site deverá ter um fórum para que o usuário possa ver avaliações de ex-moradores ou moradores atuais. | MÉDIA |
...
|RF-008 | Ao clicar no anúncio o usuário poderá ver mais detalhes dos imóveis e quantos hóspedes residem nele e comentário do fórum | ALTA |
|RF-009 | Ao criar no anúncio o anunciante poderá ver os comentários que são feitos pelos usuários e em um botão ser redirecionado para um local para editar os detalhes descritos por ele sobre a república. | BAIXA |
...
|RF-013 | A parte para criar um anúncio deverá ter opções para o dono de república especificar o imóvel com as comodidades e detalhes além de poder adicionar fotos do mesmo | ALTA |

### Requisitos não Funcionais

ID | DESCRIÇÃO DO REQUISITO | PRIORIDADE |
|------|----------------------------------------------|---------|
RNF-01 | A parte de cadastro deverá ser de forma simplificada podendo criar um e-mail e senha novos a partir do site ou para facilitar. | ALTA |
RNF-02 | A parte de login, a pessoa poderá logar na conta criada e se não tiver conta irá para a parte do cadastre-se | ALTA |
RNF-03 | O fórum deverá ser de forma simples e objetiva sem muitas informações para os usuários, apenas aquilo necessário | BAIXA |
